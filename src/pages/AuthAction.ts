...
export const signupActionHandler = (memberId: string, memberPassword: string, memberName: string) => {
    const URL = '/api/auth/signup'
    const signupObject = { memberId, memberPassword, memberName };

    const response = POST(URL, signupObject, {});
    return response;
};

export const loginActionHandler = (memberId:string, memberPassword: string) => {
